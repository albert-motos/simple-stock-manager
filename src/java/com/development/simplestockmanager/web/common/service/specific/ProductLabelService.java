...
public class ProductLabelService implements Serializable {
    ...
    public ProductLabelService() {
        ...
        attributes = controller.getWord(InternationalizationConstant.HEADER.PRODUCT.ATTRIBUTES);
        visibility = controller.getWord(InternationalizationConstant.HEADER.PRODUCT.VISIBILITY);
        enable = controller.getWord(InternationalizationConstant.LABEL.ENABLE.PRODUCT);
    }
